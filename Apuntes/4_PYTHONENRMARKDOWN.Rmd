...
```{r}
library(reticulate)
use_python("/Users/Miguel/anaconda3/python.exe")   #configurar la direccion que se usara de python
...
una ves hecho lo anterior se trabaja como si fuer auna funcion en R
