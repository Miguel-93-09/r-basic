...
el video esta mal, mirar que porcentajes suman mucho mas uqe uno




## EJEMPLO ACCEDIENTO A ETIQUETAS y quieriendo sumar tables, no funciono

```{r}
dimnames(hec)
dimnames(hec)[1]
dimnames(hec)$Hair
dimnames(hec)[1]$Hair[2]

# se puede recorrer elementos de una lista como en python

# notemos que unicamente el [1] señala el atributo

names <- dimnames(hec)[1]$Hair
for (x in names) {
	print (x)
}
...
a = which(names(dimnames(hec)) == "Hair")
a
