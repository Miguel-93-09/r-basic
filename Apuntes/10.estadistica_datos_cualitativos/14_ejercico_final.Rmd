...
# aqui hay que hacer transpuesta porque se considera que marginal es la segunda variable
...
# notemos que unicamente el [1] señala el atributo, por lo que no se consiguiria lo que queremos, e smejor así:
...
simplificar <- function(x,y){
  names <- dimnames(x)[[y]]   # nota que luego ni siquiera s eusa el i
  for (i in names) {
