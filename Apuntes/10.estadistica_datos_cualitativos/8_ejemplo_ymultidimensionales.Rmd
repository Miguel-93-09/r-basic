...
imaginemos como EJEMPLO en el caso anterior que queremos "normalizar" respecto a genero , para ver que proporcion es mas diferenciada respecto de los 4 paises
```{r}
prop.table(TT["N", ,], margin = 2)

t2 = abs(prop.table(TT["N", ,], margin = 2)[1,] - prop.table(TT["N", ,], margin = 2)[2,])
t2
t2[t2 == max(t2)]  # aqui ya veriamos que en peru hay mas diferencia entre opiniones 
...
```
 para entender , muestra HOMBRES que dijeron que NO 
