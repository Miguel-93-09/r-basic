...
# con esto alimentamos a names para que muestre el nombre de dicho level, notemos que en si which(table(x)==1) es otra table pero filtrada
...
aqui filtramos la tabla, notemos que la tabla se peude filtrar directamente, la tabla al filtrar es como un vector unico solo de la segunda fila
