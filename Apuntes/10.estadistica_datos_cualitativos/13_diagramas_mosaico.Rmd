...
las de tres dimensiones son mas dificles de leer, pero pueden hacerse, la primera es como si fuese marginal
...
```{r}
mosaic3d(t, type = "expected", box = TRUE, col = c("pink","lightblue", "blue"))
