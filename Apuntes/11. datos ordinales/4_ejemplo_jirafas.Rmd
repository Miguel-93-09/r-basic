...
barplot(cumsum(prop.table(table(jir))), main = "diagrama frec rel acumuladas")
...
barplot(cumsum(table(jir)), main = "diagrama frec acumuladas")
...
barplot((table(jir)), main = "diagrama frec absolutas")

```
```{r}

barplot(prop.table(table(jir)), main = "diagrama frec absolutas relativas")
