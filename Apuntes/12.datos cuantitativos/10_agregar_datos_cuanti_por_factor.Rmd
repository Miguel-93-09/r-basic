...
esto solo se ve bien en html, summary es complejo
...
by1 <- c("red", "red", 1, 2, NA, "big", 1, 2, "blue", 1, NA, 12)

# LO que esta pasando  es que el by1 esta agrupando cada vector del DF, entonces en v1, entonces el primer y segundo valor del DF, 1 y 3 respectivamente, se consideran como una coleccion a la que se le saca el primeio, es decir en v1 a 1 y 3, son red, en v2 lo son 11 y 33 
