...
ademas las variables de DF no son variables propiamente por lo que no se puede acceder a ellas, para ello deberian guardarse en una variable definida por nosotros, es decir, se trata de en DF como objeto completo, esto se conoce como variables internas.
