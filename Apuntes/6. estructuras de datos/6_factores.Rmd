...
la diferencia esta en que esta ultima convierte el vector en factor, y toma lo que ya esta como factores, 
...
nombres_f3
# notemos que esto de darle labels, cambia los nombre propiamente asi como levels
...
es importante que los levels sean igual que los elementos del vector, o no los detectara.
...
ejemplo1 = factor(notas, levels = c("1","2","3"), labels = c("a","a", "c"))   
...
#notemos que los labels se asocian en orden natural de los elementos del vector, no usamos levels ya que queremos renombrar directamente
...
```
tambien se puede forzar el orden con levels
